...
open class OrderListModel : ListViewModel<Order> {
    override fun getListData(keyWords: String?,pageIndex: Int, pageSize: Int, callBack: HttpRequestCallBackKT<List<Order>>) {
        HttpUtils.getInstance().getUserOrderList(keyWords, 0, pageIndex, pageSize, callBack)
    }
}